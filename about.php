        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">Threefood</h1>
              <h5 class="">Toko Daging Ayam Potong Segar Online</h5>
              <a
                  href="https://wa.me/6281298798952"
                  target="_blank"
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">Threefood</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>CV. Threefood merupakan perusahaan yang bergerak di dalam bidang pemotongan hewan ayam dan perdagangan ayam potong, CV. Threefood berkantor di Pengasinan, Gunung Sindur, Bogor pada saat ini CV. Threefood fokus melakukan perdagangan/suplay ayam potong kebeberapa perusahaan industri pengolahan ayam, juga rutin mengisi beberapa pedagang pasar di area Jabotabek CV. Threefood mandiri bervisi menciptakan sinergi kemitraaan yang saling menguntungkan dan berkeadilan memiliki sumber daya manusia yang professional, disiplin, handal, dan setia yang akan menghadirkan ayam dengan kualitas Aman, Sehat, Utuh dan Halal (ASUH) terbaik. CV. Threefood terdaftar di Kementrian Hukum dan Hak Asasi Manusia Republik Indonesia Direktorat Jenderal Administrasi Hukum Umum dengan Nomor AHU-0005973-AH-01-15 Tahun 2019 melalui Kantor Notaris  Awendi Kamuli, SH.</p>
            </div>
          </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
              &copy; 2021 Copyright by Threefood. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
